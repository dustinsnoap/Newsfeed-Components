// Because classes are not hoised you will need to start your code at the bottom of the page.
...
class Article {
  ...
  expandArticle() {
    ...
    this.expandButton.innerText = "make small"
  }
}
...
let articles = document.querySelectorAll('.article')
  .forEach(artGarfunkle => new Article(artGarfunkle))
